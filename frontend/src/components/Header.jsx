...
const Header = () => {
  ...
  <Link to = "/">
   ...
   <input type='text' id = "search" name = "search" placeholder='Search...' className='bg-transparent focus:outline-none w-24 sm:w-64 ' />
   <Link to = ""><BiSearch size = {20} className='text-slate-600' /></Link>
   </form>
